...
st.title("测试结果")
count = st_autorefresh(interval=10000, limit=10000, key="fizzbuzzcounter")
...
if st.session_state["policy"] is not None:
    ...
    if st.session_state["do_attack"] and "atk_succ_rate"in st.session_state and "robust_rate"in st.session_state:
        ...
        pass
    if st.session_state["do_env_change"] and "env_stats_mean_rew" in st.session_state and "rew_change_mean_rew" in st.session_state:
